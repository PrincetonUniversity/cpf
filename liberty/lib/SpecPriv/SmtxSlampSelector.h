...
struct SmtxSlampSelector : public ModulePass, public Selector
{
  static char ID;
  SmtxSlampSelector() : ModulePass(ID), Selector() {}
  ...
  {
    if(PI == &SmtxSlampSelector::ID)
      return (SmtxSlampSelector*)this;

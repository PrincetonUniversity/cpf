...
void PipelineStage::print_inst_txt(raw_ostream &fout, ControlSpeculation *ctrlspec, Instruction *inst, StringRef line_suffix) const
{
  fout << "    ";
...
PipelineStage::PipelineStage(Type t, const PDG &pdg, const SCCs &sccs, const SCCs::SCCSet &scc_list)
...
void PipelineStage::print_txt(raw_ostream &fout, ControlSpeculation *ctrlspec, StringRef line_suffix) const
{
  if( ! replicated.empty() )
  {
...
void PipelineStrategy::dump_pipeline(raw_ostream &fout, ControlSpeculation *ctrlspec, StringRef line_suffix) const
{
  if( !isValid() )
  {

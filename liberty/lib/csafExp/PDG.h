...
struct PDG
{
  ...
  bool tryRemoveMemEdge(Vertices::ID src, Vertices::ID dst,
  ...
  bool tryRemoveIntraIterationMemEdge(Vertices::ID src, Vertices::ID dst);
  bool tryRemoveIntraIterationCtrlEdge(Vertices::ID src, Vertices::ID dst);
  bool tryRemoveIntraIterationRegEdge(Vertices::ID src, Vertices::ID dst);

  //bool tryRemoveAllCriticisms(Complaints complaints);
  */

...
void ProfilePerformanceEstimatorOLD::getAnalysisUsage(AnalysisUsage &au) const
{
...
bool ProfilePerformanceEstimatorOLD::runOnModule(Module &mod)
{
  return false;
}
...
unsigned long ProfilePerformanceEstimatorOLD::relative_weight(const Instruction *inst)
{
...
unsigned long ProfilePerformanceEstimatorOLD::estimate_weight(const Instruction *inst)
{
...
double ProfilePerformanceEstimatorOLD::estimate_parallelization_weight(const Instruction *inst, const Loop* target_loop)
{
...
void ProfilePerformanceEstimatorOLD::visit(const Function *fcn)
{
...
void ProfilePerformanceEstimatorOLD::visit(const Function *fcn, const Loop *loop, const SubLoopIter &subloop_begin, const SubLoopIter &subloop_end, const MemberIter &members_begin, const MemberIter &members_end)
{
  ModuleLoops &mloops = getAnalysis< ModuleLoops >();
  LoopInfo &loops = mloops.getAnalysis_LoopInfo(fcn);
  LoopProfLoad &lprof = getAnalysis< LoopProfLoad >();
...
void ProfilePerformanceEstimatorOLD::reset()
{
  // reset our cache
  ctx2timeAndWeight.clear();
}

char ProfilePerformanceEstimatorOLD::ID = 0;
static RegisterPass< ProfilePerformanceEstimatorOLD > ppe("profile-performance-estimator-old", "Profile-guided performance estimator");

#ifndef LLVM_LIBERTY_SPEC_PRIV_PROFILE_PERFORMANCE_ESTIMATOR_OLD_H
#define LLVM_LIBERTY_SPEC_PRIV_PROFILE_PERFORMANCE_ESTIMATOR_OLD_H
...
struct ProfilePerformanceEstimatorOLD : public ModulePass, public PerformanceEstimatorOLD
{
  static char ID;
  ProfilePerformanceEstimatorOLD() : ModulePass(ID) {}

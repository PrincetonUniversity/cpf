...
namespace liberty
{
  ...
  public:
    ...
    virtual SchedulingPreference getSchedulingPreference() const { return SchedulingPreference( Low - 2 ); }
    StringRef getLoopAAName() const { return "callsite-depth-combinator-ctrl-spec-aa"; }

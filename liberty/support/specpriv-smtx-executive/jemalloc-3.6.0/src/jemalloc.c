...
je_malloc(size_t size)
{
  ...
  //fprintf(stderr, "\tmalloc returns %p, size %lu\n", ret, size);
...
__specpriv_malloc(size_t size)
{
  ...
  //fprintf(stderr, "\t__specpriv_malloc returns %p, size %lu\n", ret, size);

	return (ret);
}

void *
__specpriv_ver_malloc(size_t size)
{
	void *ret;
	size_t usize JEMALLOC_CC_SILENCE_INIT(0);
  ...
  //fprintf(stderr, "\t__specpriv_ver_malloc returns %p, size %lu\n", ret, size);
...
label_return:
  ...
  //fprintf(stderr, "\tcalloc returns %p, size %lu\n", ret, num*size);
...
#if 0
void *
__specpriv_calloc(size_t num, size_t size)
{
	void *ret;
	size_t num_size;
	size_t usize JEMALLOC_CC_SILENCE_INIT(0);
...
label_return:
  ...
  //fprintf(stderr, "\t__specpriv_calloc returns %p, size %lu\n", ret, num*size);

	return (ret);
}

void *
__specpriv_ver_calloc(size_t num, size_t size)
{
	void *ret;
	size_t num_size;
	size_t usize JEMALLOC_CC_SILENCE_INIT(0);
...
label_return:
  ...
  //fprintf(stderr, "\t__specpriv_ver_calloc returns %p, size %lu\n", ret, num*size);
...
je_realloc(void *ptr, size_t size)
{
  ...
  //fprintf(stderr, "\trealloc returns %p, ptr: %p, size %lu\n", ret, ptr, size);
...
#if 0
void *
__specpriv_realloc(void *ptr, size_t size)
{
	void *ret;
	size_t usize JEMALLOC_CC_SILENCE_INIT(0);
	size_t old_usize = 0;
  ...
  //fprintf(stderr, "\t__specpriv_realloc returns %p, ptr: %p, size %lu\n", ret, ptr, size);

	return (ret);
}

void *
__specpriv_ver_realloc(void *ptr, size_t size)
{
	void *ret;
	size_t usize JEMALLOC_CC_SILENCE_INIT(0);
	size_t old_usize = 0;
  ...
  //fprintf(stderr, "\t__specpriv_ver_realloc returns %p, ptr: %p, size %lu\n", ret, ptr, size);
...
#if 0
void
__specpriv_free(void *ptr)
{
  //fprintf(stderr, "\t__specpriv_free %p\n", ptr);
...
void
__specpriv_ver_free(void *ptr)
{
  //fprintf(stderr, "\t__specpriv_ver_free %p\n", ptr);

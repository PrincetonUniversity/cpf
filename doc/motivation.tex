...
\input{figures/example_additive} \end{minipage} }
  ...
  \caption{Sequential code examples. Assume that the outer loop is parallelized
and arrays \textit{b}, \textit{c} are liveout.} \end{figure*}
...
loop is in light-grey and checks, logging are in grey. Assume that the outer loop is parallelized
and arrays \textit{b}, \textit{c} are liveout.}
\end{figure*}

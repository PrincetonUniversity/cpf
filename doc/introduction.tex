...
%analyis limitations
%
%Automatic parallelization utilizes analysis and enabling
%transformations to distribute, without data races, work across
%processes or threads.  A key enabling transformation is
%privatization, where private copy are created for each worker to
%address contention in the case of data structures reuse.
%
...
Combining static with cheap-to-validate speculative assumptions also

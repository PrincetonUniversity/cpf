...
dependence structure comes with a high cost.  Even if we assume that
...
Correctly merging the private memory state of parallel workers often
forces speculative systems to monitor large write sets during parallel
execution, significantly degrading their

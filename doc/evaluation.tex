...
Figure \ref{fig:multi-core-scale} presents whole program speedups,
automatically yielded by \name, for all benchmarks with varying number
of cores. These speedups are relative to sequential performance of the
original code, compiled with \texttt{clang -O3}. \name achieves
scalable performance on all the benchmarks.

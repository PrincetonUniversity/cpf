...
%big problem
The promise of automatic parallelization for general purpose programs remains
unrealized.
% prior work?
...
%parallelization,
Speculation overcomes static analysis' limitations and offers increased
applicability, but software-only speculative systems often suffer from
...
machine, a geomean whole-program speedup of 23.8$\times$ over sequential
execution and 2$\times$

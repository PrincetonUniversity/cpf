...
on real hardware beyond a small set of benchmarks, due to high
communication costs for memory flow speculation, extensive privitization,
...
LLVM-based compiler that selects minimal-cost solutions to parallelization
inhibitors from a wide range of enabling transformations, and a lightweight

...
To overcome this limitation, \name introduces a compiler design where static code analyses and speculation techniques are tightly coupled (described in section~\ref{analyzer}) to boost the discovery of parallelization opportunities.
...
These tight integrations are accomplished introducing new interfaces between compilation passes (section~\ref{enablers}) that enabled their non-linear and fine-grained interactions.

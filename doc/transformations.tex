...
%
% XXX Make sure to add that assertions need to be validated at runtime
% later on
% The applicability guard also records the speculative assertions used
% to infer applicability for a memory object. These assertions would
...
%transform itself and the cost of the speculative assertions
...
example,
%regarding speculative assertions,
...
%ordering among transform. Speculative assertions is similarly
%computed.
%
